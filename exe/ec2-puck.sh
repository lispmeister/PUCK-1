...
#
# Usage: $0 DB-key  picture  puck-ID  name  email  pgp_fingerprint
#
puck_host="https://pi"
puck_port="8080"
...
curl -k -v -H "Accept: application/json" -H "Content-type: application/json" -X POST -d "@$new_puck" $puck_url 2> $results
