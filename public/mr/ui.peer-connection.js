...
// var SIGNALING_SERVER = 'wss://192.168.0.141:12034';
// var SIGNALING_SERVER = 'wss://10.49.151.1:12034';
var SIGNALING_SERVER = 'wss://192.168.0.141:12034';

rtcMultiConnection.openSignalingChannel = function(config) {

    console.log('opening up to signaling chan...')
    console.log(config)
    ...
    websocket.onopen = function() {
        console.log('sig channel opened...')
    ...
    websocket.send = function(data) {
        console.log('sending signals to ' + SIGNALING_SERVER)
        websocket.push(JSON.stringify({
            data: data,
            channel: config.channel
        }));
